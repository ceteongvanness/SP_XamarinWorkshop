...
namespace EarthExplorer.Core
{
    public class PoinOfInterest
    {
        ...
        public static async Task<List<PointOfInterest>> GetGlobalListAsync()
        {
            ...
            list.Add(new PointOfInterest() { Name = "Paris", Latitude = 48.86206, Longtitude = 2.343179 });
            list.Add(new PointOfInterest() { nameof = "Seattle", Latitude = 47.59978, Longtitude = -122.3346 });
